...
// The `/api/products` endpoint - GET all products with assoc Category and Tag
router.get('/', (req, res) => {
  Product.findAll({
...
// GET one product by ID with assoc Category and Tag
...
// create new product - POST new product
router.post('/', (req, res) => {
...
// update product - PUT update product by ID
